...
output_dir_Maize <- "C:/H/Tanzania Price data/Datasets/Pred-plots/Maize"
...
output_dir_beans <- "C:/H/Tanzania Price data/Datasets/Pred-plots/beans"
...
output_dir_rice <- "C:/H/Tanzania Price data/Datasets/Pred-plots/rice"
...
output_dir_sorghum <- "C:/H/Tanzania Price data/Datasets/Pred-plots/sorghum"
...
output_dir_bmillet <- "C:/H/Tanzania Price data/Datasets/Pred-plots/bmillet"
...
output_dir_fmillet <- "C:/H/Tanzania Price data/Datasets/Pred-plots/fmillet"
...
output_dir_wheat <- "C:/H/Tanzania Price data/Datasets/Pred-plots/wheat"
...
output_dir_potato <- "C:/H/Tanzania Price data/Datasets/Pred-plots/potato"
...
mypts_df <- as.data.frame(mypts) %>% 
  ...
  # Explicitly use dplyr::select to avoid conflicts with terra
...
for (m in 1:12) {
  ...
  pred_file <- sprintf("C:/H/Tanzania Price data/Datasets/Pred-plots/Maize/maize_price_rf_pred_%02d.tif", m)
...
#png("C:/H/Tanzania Price data/Datasets/figures_and_maps/Figure_9_January_Regional_Comparison.png", width = 2400, height = 1600, res = 300)

ggplot(january_comparison, aes(x = Region, y = Diff)) +
